...
app.post('/writing/intro', async (req, res, next) => {
	try {
		...
		`Introduction: Turning yourself into a brand is the best way to stand out in the crowded marketplace of ideas and products. But it doesn’t have to be expensive. In this post, I’ll show you how to create a productivity brand without breaking the bank.\n` + 
		`"""\n` +
