										...
										<div className="container flex mx-auto px-4 md:px-28 flex select-none">
														...
														<div className="relative text-gray-400 focus-within:text-green-500 flex flex-1 ">
															...
															{/*<Input 
																...
																id="q"
																name="q" 
																className="py-4 pl-4 md:pl-14 text-xl focus:outline-none focus:bg-white focus:text-gray-900 transition flex flex-1 w-full" placeholder="Search... " autoComplete="off" 
