		...
		<>
			...
			<div className="container mx-auto lg:px-4 py-4 min-h-screen flex flex-col md:items-center md:justify-center">
				...
				<div className="text-center mb-6">
					<Logo />
					<div>
						<div className="text-4xl font-bold text-gray-700">sub<span className="text-green-600 font-medium">Think Space</span><span className="text-gray-500 font-normal ">AI</span></div>
					</div>
				</div>
